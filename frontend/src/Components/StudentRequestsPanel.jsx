    ...
    const fetchResponses = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          `http://localhost:8000/request/responses/${selectedRequest.id}`
        );
    ...
    const fetchRequests = async () => {
      try {
        const response = await axios.get(
          `http://localhost:8000/requests/${user.user_email}`
        );
              ...
              <div className="modal-content card shadow-lg p-4" dir="ltr">
                      ...
                      <p>
                        ...
                        <span
                          style={{
                            ...
                            fontWeight: shouldShowDeadlineWarning(
                              selectedRequest
                            )
                              ? "bold"
                              : "normal",
                      ...
                      {(selectedRequest.files || []).map((doc, index) => (
                        ...
                        >
                          ...
                          <a
                            ...
                            href={`http://localhost:8000/downloadFile/${emailUser}/${encodeURIComponent(
                              doc
                            )}`}
                            download
                          >
                ...
                <div className="mb-3">
                  ...
                  {loadingResponses ? (
                    ...
                    <p className="text-muted">
                      There are no replies for this requests.
                    </p>
                  ) : (
                    <div className="timeline">
                ...
                <div className="text-end mt-3">
                  {selectedRequest.status === "expired" && (
                    ...
                    >
                      <strong>⏰ Request Expired:</strong> This request has
                      passed its deadline and cannot be edited or deleted.
                    </div>
                  )}
                  {/*<button*/}
                  ...
                  {(selectedRequest.status === "pending" ||
                    selectedRequest.status === "require editing") &&
                    selectedRequest.status !== "expired" &&
                    !isEditing && (
                      <Fab
                        color="secondary"
                  ...
                  {(selectedRequest.status === "pending" ||
                    selectedRequest.status === "not read") &&
                    selectedRequest.status !== "expired" && (
                      <button
