...
function ProfessorRequestsPanel() {
  ...
  // Updated state variables for filtering
  ...
  // Function to load students from the /users API
  ...
  useEffect(() => {
    checkAuth();
    // Load students for both professors and secretaries
    loadStudents();
  }, [checkAuth]);
  ...
  useEffect(() => {
    ...
    if (studentFilter) {
      filteredRequests = filteredRequests.filter(
          (req) => req.student_email === studentFilter
      );
    }
  ...
  }, [sortBy, requests, hideCompleted, studentFilter]);
  ...
  const getStudentNameByEmail = (email) => {
    const student = allStudents.find(s => s.email === email);
    return student ? student.name || student.full_name || email : email;
  };
  ...
  return (
      <div className="container-fluid mt-4">
        <h1 className="text-center mb-4">
          <strong>
            ...
            {studentFilter && (
                ...
                >
              Filtered by: {getStudentNameByEmail(studentFilter)}
            </span>
            )}
          </strong>
        </h1>
        ...
        <div className="d-flex justify-content-end mb-3">
          {/* Student Filter - Now available for both professors and secretaries */}
          <FormControl
              variant="outlined"
              className="me-2"
              sx={{ minWidth: 200 }}
            ...
            >
              ...
              {allStudents.map((student) => (
                  <MenuItem key={student.email} value={student.email}>
                    {student.name || student.full_name || student.email} ({student.email})
                  </MenuItem>
              ))}
            </Select>
          </FormControl>
              ...
              >
                <div className="card request-card shadow-lg">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <strong>From :</strong> {getStudentNameByEmail(req.student_email)} ({req.student_email})
                    </p>
                    {req.deadline_date && (
                        <p
                            className="card-text"
                ...
                <div className="modal-content card shadow-lg p-4" dir="ltr">
                  ...
                  <div className="row mb-3">
                    <div className="col-md-6">
                      ...
                      <p>
                        <strong>From:</strong> {getStudentNameByEmail(selectedRequest.student_email)} ({selectedRequest.student_email})
                      </p>
